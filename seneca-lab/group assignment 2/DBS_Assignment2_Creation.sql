---------------------------------------------------------------------------------------------------------------
-- Name: Anh-Bang Truong (Ethan), Alexander Holmes, Matheus Leitao, Valentin-Gabriel Vlad
-- ID: 124753179, 037587136, 148300171, 110088184
-- Group: 7
-- Assignment 2
-- Check tables on Anh-Bang Truong 
---------------------------------------------------------------------------------------------------------------
...
CREATE TABLE G7Ownership (
    client_id                   VARCHAR(10), 
    property_id                 INT,
    ownership_percentage        DECIMAL(6,4)            NOT NULL,
...
CREATE TABLE G7References (
    ...
    reference_fee       DECIMAL(3,2)                 NOT NULL,
    client_id           VARCHAR(10),
...
CREATE VIEW vwPropForSale AS (
    SELECT property_id, property_price, property_status
        FROM G7Properties_info
