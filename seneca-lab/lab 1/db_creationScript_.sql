...
INSERT INTO employees VALUES 
        ...
        , 'LDEHAAN'
        , '515.123.4569'
        , TO_DATE('13-JAN-2013', 'dd-MON-yyyy')
        , 'AD_VP'
        , 17000
        , NULL
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'KMOURGOS'
        , '650.123.5234'
        , TO_DATE('16-NOV-2019', 'dd-MON-yyyy')
        , 'ST_MAN'
        , 5800
        , NULL
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'EZLOTKEY'
        , '011.44.1344.429018'
        , TO_DATE('29-JAN-2020', 'dd-MON-yyyy')
        , 'SA_MAN'
        , 10500
        , .2
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'EABEL'
        , '011.44.1644.429267'
        , TO_DATE('11-MAY-2016', 'dd-MON-yyyy')
        , 'SA_REP'
        , 11000
        , .30
        , 149
...
INSERT INTO employees VALUES 
        ...
        , 'JTAYLOR'
        , '011.44.1644.429265'
        , TO_DATE('24-MAR-2018', 'dd-MON-yyyy')
        , 'SA_REP'
        , 8600
        , .20
        , 149
...
INSERT INTO employees VALUES 
        ...
        , 'KGRANT'
        , '011.44.1644.429263'
        , TO_DATE('24-MAY-2019', 'dd-MON-yyyy')
        , 'SA_REP'
        , 7000
        , .15
        , 149
...
INSERT INTO employees VALUES 
        ...
        , 'MHARTSTE'
        , '515.123.5555'
        , TO_DATE('17-FEB-2016', 'dd-MON-yyyy')
        , 'MK_MAN'
        , 13000
        , NULL
        , 100
...
INSERT INTO employees VALUES 
        ...
        , 'PFAY'
        , '603.123.6666'
        , TO_DATE('17-AUG-2017', 'dd-MON-yyyy')
        , 'MK_REP'
        , 6000
        , NULL
        , 201
...
INSERT INTO employees VALUES 
        ...
        , 'SHIGGINS'
        , '515.123.8080'
        , TO_DATE('07-JUN-2014', 'dd-MON-yyyy')
        , 'AC_MGR'
        , 12020
        , NULL
        , 101
...
VALUES (102
       , TO_DATE('13-JAN-2013', 'dd-MON-yyyy')
       , TO_DATE('24-JUL-2018', 'dd-MON-yyyy')
       , 'IT_PROG'
       , 60);
...
VALUES (101
       , TO_DATE('21-SEP-2009', 'dd-MON-yyyy')
       , TO_DATE('27-OCT-2013', 'dd-MON-yyyy')
       , 'AC_ACCOUNT'
       , 110);

INSERT INTO job_history
VALUES (101
       , TO_DATE('28-OCT-2013', 'dd-MON-yyyy')
       , TO_DATE('15-MAR-2017', 'dd-MON-yyyy')
       , 'AC_MGR'
       , 110);
...
VALUES (201
       , TO_DATE('17-FEB-2016', 'dd-MON-yyyy')
       , TO_DATE('19-DEC-2019', 'dd-MON-yyyy')
       , 'MK_REP'
       , 20);
...
VALUES  (114
        , TO_DATE('24-MAR-2018', 'dd-MON-yyyy')
        , TO_DATE('31-DEC-2019', 'dd-MON-yyyy')
        , 'ST_CLERK'
        , 50
        );
...
VALUES  (200
        , TO_DATE('17-SEP-2007', 'dd-MON-yyyy')
        , TO_DATE('17-JUN-2013', 'dd-MON-yyyy')
        , 'AD_ASST'
        , 90
        );
